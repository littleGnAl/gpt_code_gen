# Copy from https://github.com/openai/openai-cookbook/blob/main/examples/api_request_parallel_processor.py
...
async def process_api_requests_from_file(
    ...
    max_attempts: int,
    logging_level: int,
    on_success: Callable[[int, dict, Any], None],
):
...
class APIRequest:
    ...
    async def call_api(
        ...
        if error:
            ...
            try:
                self.on_success(self.task_id, self.request_json, response)
